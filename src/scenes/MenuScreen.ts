      ...
      <section class="screen screen--menu">
        <div class="hero-panel" data-testid="main-menu-screen">
          <div class="hero-panel__content">
            ...
            <p class="hero-copy">
              Lead a four-agent strike cell through plazas, relay labs, and blacksites in a clean,
              readable cyber-SF tactics slice.
            </p>
        ...
        <div class="intel-grid">
          <article class="intel-card">
            ...
            <p>Clean squad control, readable real-time combat, and compact progression.</p>
          </article>
          <article class="intel-card">
            <h2>Vertical Slice</h2>
            <p>Three operations: eliminate, rescue and extract, then sabotage and escape.</p>
          </article>
          <article class="intel-card">
            <h2>Build Notes</h2>
            <p>Playable placeholder art stays separate while the production look is built out.</p>
          </article>
        </div>
      </section>
    `;
